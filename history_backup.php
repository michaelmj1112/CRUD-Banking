    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="history">
                ...
                $result = $mysqli->query("SELECT * FROM transactions WHERE account_id = '1' LIMIT $startFrom, $perPageRecord")
                    or die($mysqli->error);
                ?>
                ...
                <?php
                    $count = $mysqli->query("SELECT COUNT(*) FROM transactions WHERE account_id = 1");
                    ...
                    if ($page >= 2) {
                        echo "<a class='prev-next' href='history_backup.php?page=".($page - 1)."'> Prev </a>";
                    }
                    ...
                    if ($page < $totalPages) {
                        echo "<a class='prev-next' href='history_backup.php?page=".($page + 1)."'>Next</a>";
                    }
