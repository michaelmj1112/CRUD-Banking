...
<html>
    ...
    <body>
        ...
        <div class="container">
                ...
                <h1 class="user">Welcome! <?php echo $row['firstname'] . " " . $row['lastname']; ?></h1>
                <h2 class="accNum">Account number: <?php echo $row['account_number']; ?></h2>
                <?php $balance = number_format($row['balance'], 2, '.', ','); ?>
                <h2 class="balance">Available balance: TWD <?php echo $balance; ?></h2>
                <?php endwhile; ?>
        </div>
    </body>
